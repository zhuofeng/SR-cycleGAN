...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # model parameters
        parser.add_argument('--model', type=str, default='medical_cycle_gan', help='chooses which model to use. [cycle_gan | pix2pix | test | colorization]')
        ...
        # dataset parameters
        parser.add_argument('--dataset_mode', type=str, default='medical_2D', help='chooses how datasets are loaded. [unaligned | aligned | single | colcolorizationtion]')
        ...
        parser.add_argument('--max_dataset_size', type=int, default=float(40000), help='Maximum number of samples allowed per dataset. If the dataset directory contains more than max_dataset_size, only a subset is loaded.')
