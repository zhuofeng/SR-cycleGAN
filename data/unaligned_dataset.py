...
class UnalignedDataset(BaseDataset):
    ...
    def __init__(self, opt):
        ...
        self.dir_A = os.path.join(opt.dataroot, opt.phase + 'A')  # create a path '/path/to/data/trainA'  dataroot是指定的数据文件夹,目前是./datasets/maps. 
    ...
    def __getitem__(self, index):
        ...
        A_img = Image.open(A_path).convert('RGB')  #Returns: An Image object. 这里才是真正读取图像文件
