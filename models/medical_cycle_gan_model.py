...
class MedicalCycleGANModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        if is_train:
            ...
            parser.add_argument('--downsample_loss', type=float, default=10.0, help='downsample_loss')
            parser.add_argument('--upsample_loss', type=float, default=10.0, help='upsample_loss')
    ...
    def __init__(self, opt):
        ...
        self.loss_names = ['D_A', 'G_A', 'cycle_A', 'idt_A', 'D_B', 'G_B', 'cycle_B', 'idt_B', 'downsample', 'upsample']
    ...
    def forward(self):
        ...
        #print(self.fake_B.shape) [2, 1, 256, 256]
        #print(self.rec_A.shape)  [2, 1, 32, 32]
        #print(self.fake_A.shape)  [2, 1, 32, 32]
        #print(self.rec_B.shape)  [2, 1, 256, 256]
